...
interface SonseiBatteryIndicatorProps {
  batteryLevel: number;
  batteryStatus: number;
}

const SonseiBatteryIndicator = ({ batteryLevel, batteryStatus }: SonseiBatteryIndicatorProps) => {
...
export default SonseiBatteryIndicator;
