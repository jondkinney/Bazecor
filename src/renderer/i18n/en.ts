...
const English = {
  ...
  editor: {
    ...
    standardView: {
      ...
      layerLens: {
        title: "Layout Lens",
        callOut:"Layout Lens is the on-screen overlay that shows your keyboard's active layer. 🔍 Assign these keys to control when it pops up.",
        toggleLayerLens: "LENS TAP",
        toggleLayerLensDescription: "Tap to show Layout Lens, tap again to hide it.\n ",
        holdLayerLens: "LENS HOLD",
        holdLayerLensDescription: "Hold to show Layout Lens, release and it hides automatically.",
        superKey: "SK-LENS",
  ...
  wireless: {
    ...
    energyManagement: {
      ...
      settings: {
        ...
        tooltipLowConsumptionMessage: "Minimum coverage but increased battery life.",
      },
    },
    batteryPreferences: {
      battery: "Battery",
 ...
 You will lose all customizations made.`,
  ...
  firmwareUpdate: {
    texts: {
      ...
      calloutIntroText3: "Make sure your keyboard is connected directly to your computer; no hubs or KVMs, please 😊",
      ...
      progressCardStatusDefy5: "   Restoring your Layers!",
      progressCardStatusDefy6: "5. Firmware update!",
      progressCardStatusSonsei1: "1. Initializing the brain-to-key connection",
      progressCardStatusSonsei2: "2. Taking a quick power nap",
      progressCardStatusSonsei3: "3. Learning new skills",
      progressCardStatusSonsei4: "   Remembering your personal touch",
      progressCardStatusSonsei5: "4. Evolution complete!",
      ...
      progressCardBarSonsei1: "Your keyboard should be pulsing pink",
      progressCardBarSonsei2: "Resetting the system",
      progressCardBarSonsei3: "Don’t unplug",
      progressCardBarSonsei4: "Restoring the soul of your thumbkeys",
      progressCardBarSuccess: "",
    ...
    milestones: {
      ...
      checkBootloaderStatus: "Check Bootloader status",
