...
describe('parsePaletteRaw', () => {
  it('should parse RGB data', () => {
    expect(parsePaletteRaw("10 20 30", false))
      .toEqual([{ r: 10, g: 20, b: 30, rgb: "rgb(10, 20, 30)" }]);
  });

  it('should parse RGBW data', () => {
    expect(parsePaletteRaw("10 20 30 40", true))
      .toEqual([{ r: 50, g: 60, b: 70, rgb: "rgb(50, 60, 70)" }]);
  });

  it('should normalize numbers data', () => {
    expect(parsePaletteRaw("-10 400 10", true))
      .toEqual([{ r: 0, g: 255, b: 10, rgb: "rgb(0, 255, 10)" }]);
  });
