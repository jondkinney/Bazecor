    ...
    <>
      ...
      {keyType == "sonsei-t1" ? (
        <g
          ...
          data-key-index={dataKeyIndex}
          data-layer={dataLayer}
          transform={transform ? `translate(${x},${y}) ${transform}` : `translate(${x},${y})`}
          style={{ display: hidden ? "none" : "initial" }}
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M10.57446 4.46654C10.9078 3.46654 11.37446 2.06654 10.57446 4.46654ZM10.57446 4.46654C11.95868 0.466552 15.75856 0.666542 18.95854 1.466542C29.6252 3.79988 52.0012 8.47682 55.9586 9.46654C59.957 10.46656 60.9586 10.46654 60.9586 14.46654C58.292 26.4666 51.8 52.7998 51 55.9998C50 58.9998 51 59.9998 46 58.9998L4.95854 50.4666C1.957170 49.4666 -0.0396530 50.4666 1.57447 44.4666L10.57446 4.46654Z"
              fill={color}
            />
          </g>
      ...
      {keyType == "sonsei-t2" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M16.33762 1.422808L65.1898 15.05308C66.338 15.31818 66.9586 17.86802 66.6948 19.01038L48.8998 59.4234C48.636 60.5658 46.9604 62.5856 44.6642 62.0556L3.59688 51.371C0.152613 50.5758 0.943838 47.1488 1.471324 44.864L11.22978 2.59542C12.58594 0.354614 14.50068 0.998716 16.33762 1.422808Z"
              fill={color}
            />
          </g>
      ...
      {keyType == "sonsei-t3" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M70.9894 29.472C63.9848 40.5496 49.372 63.5266 46.9564 66.8138C46.493 67.4444 45.9494 68.7284 44.7822 69.11C43.6314 69.4538 41.5432 68.9578 40.7344 68.326C30.2202 60.113 10.28146 50.8154 5.3273 49.6086C3.54426 49.1742 1.761534 47.757 1.218378 46.5892C0.577652 45.2116 1.489446 43.7138 2.00254 42.5414C7.6171 29.7122 18.25454 5.32262 19.26882 3.1475C20.114 1.334874 22.681 0.59885 24.5846 1.212732C39.9306 6.162 66.3714 20.919 70.3836 23.6726C71.6888 24.5684 72.2826 27.4268 70.9894 29.472Z"
              fill={color}
            />
          </g>
      ...
      {keyType == "sonsei-t4" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M33.9622 75.5498C25.5822 66.7308 6.82 50.088 2.02818 46.4772C1.687056 46.2202 1.229544 45.8754 1.032722 44.475C0.835902 43.0744 1.597086 42.2012 2.03954 41.4772C9.1995 29.7602 25.0402 5.96934 27.929 2.1359C29.1326 0.538626 31.0122 0.702894 32.929 2.14726C41.7796 9.23404 61.9948 26.0534 72.0508 36.6362C73.4474 38.106 73.0788 41.9186 71.6344 43.8352C64.2852 50.8186 47.5822 66.7806 39.564 74.7626C38.2292 75.4262 35.24 76.5126 33.9622 75.5498Z"
              fill={color}
            />
          </g>
      ...
      {keyType == "sonsei-tR1" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M72.426 4a4 4 0 00-4-4H4.224A4 4 0 00.23 4.218l2.39 43.81a4 4 0 003.994 3.782h61.812a4 4 0 004-4V4z"
              fill={color}
            />
          </g>
          ...
          <g className="shadowMiddle" transform={`translate(${0},${12})`}>
            <path
              d="M66.6 4a4 4 0 00-4-4H4.077A4 4 0 00.086 4.244l2.336 38.159a4 4 0 003.992 3.755H62.6a4 4 0 004-4V4z"
              fill={color}
            />
          </g>
          <g transform={`translate(${4},${0})`}>
